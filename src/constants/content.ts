  ...
  experiences: [
    {
      ...
      details: [
        "IT Governance & Standardization: Definition and orchestration of migration strategy for multiple vertical platforms towards a single, flexible, and scalable infrastructure, ensuring architectural and operational consistency.",
        "Process Optimization: Standardization of duplicate operational flows into unified and maintainable processes, significantly reducing technical debt and enhancing efficiency of Digital Factory.",
        "Strategic Alignment: Assisting in elicitation of business and technical requirements to optimize product roadmap in alignment with strategic corporate objectives.",
      ],
    },
    {
      ...
      details: [
        "Change Management: Facilitating organizational and cultural shifts to improve business process efficiency during migration of legacy systems to global platforms.",
        "Stakeholder Management: Normalizing requirements from internal and external stakeholders, identifying common patterns to accelerate resolution of systemic issues.",
        "Delivery Governance: Identifying bottlenecks in delivery lifecycle and implementing strategies to increase resource productivity and operational output.",
      ],
    },
    {
      ...
      details: [
        "Portfolio Management: Defining and maintaining product roadmap in alignment with market trends and long-term business goals.",
        "Resource Coordination: Overseeing entire product lifecycle, ensuring transparent planning and effective collaboration across diverse development teams.",
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        "Role Evolution: Joined as a Front End Developer and expanded scope to include user experience design. Promoted to Fullstack Designer, bridging technical and design competencies to create user-centric digital products.",
    ...
    },
    {
      ...
      details: [
        "Development of a web platform dedicated to world of small entrepreneurs, with objective of collecting user requests and directing them to right professionals.",
      ],
    },
    {
  ...
  projects: [
    {
      ...
      description:
        "Saas B2B for data modeling and data governance based on blockchain technology. Datome allows clients to easily integrate all the advantages of blockchain into their existing data infrastructure.",
    },
    {
      title: "ChainKpr",
      role: "Product Manager",
    ...
    },
    {
      ...
      role: "Frontend Lead",
      description:
        "Managed frontend development of web platform. Coordinated a team of 6 developers, including 4 offshore and 2 onsite resources.",
    },
    {
      title: "UniCredit",
      role: "Frontend Lead",
