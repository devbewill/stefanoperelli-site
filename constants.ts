    ...
    projects: [
      {
        ...
        role: "Frontend Lead",
        description: "Gestione dello sviluppo front end della piattaforma web. Coordinamento di un team di 6 sviluppatori (4 offshore, 2 onsite)."
      },
      {
        title: "UniCredit",
        role: "Frontend Lead",
        description: "Riprogettazione dei tool operativi delle countries dell’Est Europa all’interno di un’unica piattaforma web condivisa."
      },
      {
        title: "Retail E-commerce",
        role: "Frontend Developer",
        description: "Progettazione e sviluppo frontend per piattaforme e-commerce (Unes, Iper, Coop, Conad). Ottimizzazione UX per compatibilità cross-browser."
      }
    ],
    skills: [
      {
    ...
    projects: [
      {
        title: "Ho Mobile (Vodafone)",
        role: "Frontend Lead",
        description: "Managed the frontend development of the web platform. Coordinated a team of 6 developers, including 4 offshore and 2 onsite resources."
      },
      {
        title: "UniCredit",
        role: "Frontend Lead",
        description: "Redesigned operational tools for Eastern European branches into a unified, shared web platform."
      },
      {
        title: "Retail E-commerce",
        role: "Frontend Developer",
        description: "Frontend design and development for major e-commerce platforms including Unes, Iper, Coop, and Conad. Optimized user experiences for cross-browser and cross-device compatibility."
      }
    ],
    skills: [
      {
