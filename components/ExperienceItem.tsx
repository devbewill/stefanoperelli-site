    ...
    <div className="py-12 first:pt-0 group">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16">
        ...
        <div className="space-y-1">
          ...
          <h3 className="text-accent text-lg font-bold">{item.role}</h3>
          <div className="space-y-1">
            <a href={item.link} className="text-sm font-medium">
              {item.company} ↗
            </a>
            ...
            {item.details.map((detail, idx) => {
              ...
              if (hasColon) {
                ...
                return (
                  <li
                    key={idx}
                    className="flex gap-4 items-start text-sm leading-relaxed"
                  >
              ...
              return (
                <li
                  key={idx}
                  className="flex gap-4 items-start text-sm leading-relaxed text-zinc-600 dark:text-zinc-400"
                >
                  <span className="shrink-0 mt-1.5 text-teal-500">•</span>
                  <span>{detail}</span>
                </li>
